...
const Form= ({reservas, setReserva, guardarMostrarForm, guardarReservasStorage}) => {
    ...
    const crearNuevaReserva = () => {
        ...
        if(seccion.trim() == 'Fumadores' || seccion.trim() == 'No fumadores')
        {
            ...
            Alert.alert(
                'Error',           
                'Escriba una de las secciones disponibles por favor : Fumadores | No fumadores',    
                [{
                    text: 'OK'      
                }]
            )
